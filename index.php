...
switch( $action ) {
    case 'Add Task':
        ...
        if (empty($new_task)) {
            ...
            // $task_list[] = $new_task;
            //2.1 Modifying the page -- Task gets added to the top of the list
        ...
        break;
    case 'Remove Task':
        //2.3 - Removes the task at the top of the list
            $new_task = filter_input(INPUT_POST, 'newtask');
                // $task_list[] = $new_task;
                //2.1 Modifying the page -- Task gets added to the top of the list
                $arr = array('item2', 'item3', 'item4');
                
                array_splice($task_list, 0, 1);
                //array_push($task_list, $new_task);
            break;
